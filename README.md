...
* Or you can download the preprocessing GridSat data from my baidu drive through [here](<https://pan.baidu.com/s/1-wfhAyQNZIBWgz5wuxb0QQ?pwd=373w> "here"). Note that the ibtracs tropical cyclone best track dataset is provided in folder ***data***.
